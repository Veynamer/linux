...
static int sprd_vbc_config_iis_tx(struct sprd_vbc_priv *vbc, int idx,
				  u32 width, u32 lrmod)
{
	int ret;
...
static int sprd_vbc_config_iis_rx(struct sprd_vbc_priv *vbc, int idx,
				  u32 width, u32 lrmod)
{
	int ret;
